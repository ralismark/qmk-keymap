...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BASE]=LAYOUT(\
		...
		LSSBO,   KC_Z,    KC_X,    KC_C,         KC_V,         KC_B,           /**/ KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RBRC, \
		KC_LCTL, KC_GRV,  KC_LGUI, KC_LALT,      KC_SPC,       LT(_HI,KC_ENT), /**/ KC_RSFT, KC_BSPC, KC_RGUI, REPDOWN, REPUP,   KC_RCTL  \
	),

	[_HI]=LAYOUT(\
		KC_F12,  KC_F1,   KC_F2,   KC_F3,        KC_F4,        KC_F5,          /**/ KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  \
		XXXXXXX, XXXXXXX, KC_MUTE, KC_VOLU,      KC_VOLD,      XXXXXXX,        /**/ KC_HOME, KC_PGDN, KC_PGUP, KC_END,  XXXXXXX, XXXXXXX, \
		KC_GRV,  XXXXXXX, XXXXXXX, LCTL(KC_INS), LSFT(KC_INS), XXXXXXX,        /**/ KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, KC_PSCR, \
